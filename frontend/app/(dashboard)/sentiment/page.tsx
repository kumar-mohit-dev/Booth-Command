...
export default function SentimentPage() {
  ...
  // Updated state to handle numeric scores
  ...
  const handleAnalyze = useCallback(async () => {
    ...
    try {
      ...
      // Using ?? instead of || so that 0 doesn't fall back to 50
      setSentiment(data.current_sentiment ?? 50)
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <SentimentScorecard
          sentiment={sentiment} // Fallback cast depending on how your SentimentScorecard component is typed
          summary={summary}
          ward={analyzedWard}
          isLoading={isLoading}
        />
